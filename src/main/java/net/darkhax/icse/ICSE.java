...
@Mod(modid = Constants.MODID, name = Constants.MOD_NAME, version = Constants.VERSION_NUMBER, acceptableRemoteVersions = "*", dependencies = "after:Waila", acceptedMinecraftVersions = "[1.9.4,1.10.2]")
public class ICSE {
