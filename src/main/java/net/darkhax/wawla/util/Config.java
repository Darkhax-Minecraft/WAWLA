...
public class Config {
    ...
    /**
     * The configuration file is used to allow for manipulation of the modification by the user through a .cfg file usually found in the /config folder.
     * 
     * @param cfgFile: The file used for reading/writing the configuration file. Usually obtained from .getSuggestedConfigurationFile() in the preInit event.
     */
