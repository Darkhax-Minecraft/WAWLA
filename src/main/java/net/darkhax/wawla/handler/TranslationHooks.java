...
public class TranslationHooks {
    ...
    /**
     * A hook method created by Ghostrec35, this method is injected into the TranslateKey method and is called every time Minecraft attempts to translate text. The key and the provided translation will be supplied to this method. The purpose of this method in our mod is to create a list of all the broken/missing language translations in the mod, if a broken/null translation is detected it will be added to the list.
     * 
