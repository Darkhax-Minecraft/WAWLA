...
public class InfoAccess {
	 ...
	 */
	public InfoAccess(World world, EntityPlayer player, Entity entity) {
	 ...
	 */
	public InfoAccess(World world, EntityPlayer player, IBlockState state, BlockPos pos, EnumFacing side) {
