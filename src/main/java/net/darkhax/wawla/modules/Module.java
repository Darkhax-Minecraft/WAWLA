...
public class Module {
    ...
    /**
     * This method is called when minecraft renders an item tooltip. This can be used to add
     * information.
     * 
    ...
    /**
     * This method is called when waila prints a block name. This is used to manipulate the
     * display name of the block. This is the upper most section of the tool tip.
     * 
     * @param stack: An instance of an ItemStack that contains data about the block being
     *            looked at.
     * @param tooltip: A list of all the current text being displayed about the block.
     * @param access: An accessor that can be used to pull a bunch of miscellaneous
     *            information.
    ...
    /**
     * This method is called when waila prints the description of a block. This can be used to
     * add information about a block. This makes up the middle section of the tool tip.
     * 
     * @param stack: An instance of an ItemStack that contains data about the block being
     *            looked at.
     * @param tooltip: A list of all the current text being displayed about the block.
    ...
    /**
     * This method is called when waila prints the end of a block tooltip. This is used by
     * waila to print the name of the mod that owns the block.
     * 
     * @param stack: An instance of an ItemStack that contains data about the block being
     *            looked at.
     * @param tooltip: A list of all the current text being displayed about the block.
    ...
    /**
     * This method is called when waila prints the name of an entity into an entity tooltip.
     * This is used by waila to display the block name. This is the upper most part of the
     * tooltip.
     * 
     * @param entity: An instance of the entity that is currently being looked at by the
     *            player.
     * @param tooltip: An list of all the current text being displayed in the top part of the
     *            tooltip.
    ...
    /**
     * This method is called when waila prints the body of an entity tooltip. This is the
     * middle section of the tooltip.
     * 
     * @param entity: An instance of the entity that is currently being looked at by the
     *            player.
     * @param tooltip: An list of all the current text being displayed in the middle part of
     *            the tooltip.
     * @param accessor: An accessor that can be used to pull information.
     * @param config: Access to the Waila Configuration.
     */
    ...
    /**
     * This method is called when waila prints the end section of a tooltip. This is used by
     * waila to add the name of the mob that the entity is registered to.
     * 
     * @param entity: An instance of the entity that is currently being looked at by the
     *            player.
     * @param tooltip: An list of all the current text being displayed in the bottom part of
     *            the tooltip.
     * @param accessor: An accessor that can be used to pull information.
     * @param config: Access to the Waila Configuration.
     */
     ...
     * WailaEntityHandler is registered. This can be used to add config options to Waila or to
     * register nbt tags to be synchronized across client and server.
     * 
    ...
    /**
     * This method is called when Waila displays information on a block. This can be used to
     * override the block used to generate a waila tooltip with another ItemStack.
     * 
     * @param stack: The ItemStack being displayed. This can be overridden to display a custom
     *            stack.
     * @param accessor: An instance of IWailaDataAccessor containing many goodies for you to
     *            use.
     * @param config: Access to the Waila Configuration.
     */
    ...
    /**
     * This method is called when Waila displays information on an Entity. This can be used to
     * override the Entity being shown.
     * 
     * @param entity: The Entity that is being displayed. This can be overridden to display a
     *            custom Entity.
     * @param accessor: An instance of IWailaEntityAccessor containing many goodies for you to
     *            use.
     * @param config: Access to the Waila Configuration.
     */
