...
public class Module {
    ...
    /**
     * This method is called when the mod is first registered with Waila, Specifically when the WailaEntityHandler is registered. This can be used to add config options to Waila or to register nbt tags to be synchronized across client and server.
     * 
